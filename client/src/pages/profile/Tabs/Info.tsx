    ...
    <div className="p-4 bg-white dark:bg-indigo-1000 rounded-md min-h-10rem">
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-800 space-y-4 mt-8">
        <div className="grid grid-cols-3 py-4">
          ...
          {profile.fullname ? (
            <span className="text-gray-600 dark:text-gray-400 col-span-2">
              {profile.fullname}
            </span>
          ) : (
        ...
        <div className="grid grid-cols-3 py-4">
          ...
          {profile.info.gender ? (
            <span className="text-gray-600 dark:text-gray-400 col-span-2 capitalize">
              {profile.info.gender}
            </span>
          ) : (
        ...
        <div className="grid grid-cols-3 py-4">
          ...
          {profile.info.birthday ? (
            <span className="text-gray-600 dark:text-gray-400 col-span-2">
              {dayjs(profile.info.birthday).format("MMM.DD, YYYY")}
            </span>
          ) : (
        ...
        <div className="grid grid-cols-3 py-4">
          ...
          <span className="text-gray-600 dark:text-gray-400 col-span-2">
            {dayjs(profile.dateJoined).format("MMM.DD, YYYY")}
          </span>
        </div>
      </div>
    </div>
