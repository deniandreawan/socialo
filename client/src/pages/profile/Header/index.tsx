...
const Header: React.FC<IProps> = ({ profile, auth }) => {
  ...
  return (
    <div>
      ...
      {/*  ----- COVER PHOTO ------- */}
      <div
        className="w-full h-60 mb-8 laptop:mb-0 laptop:h-80 bg-gray-200 dark:bg-gray-800 relative overflow-hidden"
        ref={coverPhotoRef}
      >
        ...
        <img
          ...
          src={
            ...
            `https://source.unsplash.com/oDhGIbegZNI/1400x900`
          }
        />
      </div>
              ...
              <div
                ...
                style={{
                  background: `#f7f7f7 url(${
                    profile.profilePicture?.url || avatar_placeholder
                  })`,
                }}
              >
