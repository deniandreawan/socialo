              ...
              {messages.map(
                (message) =>
                  ...
                  message.to && (
                    ...
                    >
                      <div
                        className={`flex justify-start cursor-pointer hover:bg-gray-100 dark:hover:bg-indigo-1100 border border-transparent dark:hover:border-indigo-700 px-2 py-3 relative ${
                          !message.seen &&
                        ...
                        onClick={() =>
                          handleReadMessage(
                            message.isOwnMessage ? message.to : message.from
                          )
                        }
                      >
                        {/* --- IMAGE--- */}
                        ...
                        <div className="relative flex-grow">
                          ...
                          {/* -- MESSAGE--- */}
                          <span
                            className={`block max-w-16rem laptop:max-w-xs whitespace-nowrap overflow-hidden overflow-ellipsis ${
                              message.seen || message.isOwnMessage
                                ? "text-gray-400"
