  ...
  return (
    <div className="relative">
      {notifications.length === 0 ? (
        ...
        <div className="max-h-80vh laptop:max-h-70vh relative overflow-y-scroll divide-y divide-gray-100 scrollbar">
              ...
              {notifications.map(
                (notif) =>
                  notif.initiator && (
                    ...
                    >
                      <div
                        className={`border border-transparent dark:hover:border-indigo-700 ${
                          notif.unread
                            ? "bg-indigo-100 dark:bg-indigo-1100 hover:bg-indigo-200"
                            : "bg-white dark:bg-indigo-1000 dark:hover:bg-indigo-1100"
                        } p-4 hover:bg-gray-100 dark:hover:bg-indigo-1100 hover:opacity-95 divide-y divide-y-2 divide-gray-100`}
                        key={notif.id}
                        onClick={() =>
                          handleNotificationClick(notif.link, notif.id)
                        }
                      >
                        <div className="relative">
